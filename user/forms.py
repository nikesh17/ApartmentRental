...
#         raise ValidationError("Password is too common and easily guessable. Please choose a different password.")
...
#                                widget=forms.TextInput(attrs={'class': 'w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm', 'autofocus': True}))
#     password = forms.CharField(label=("Password"),
#                                widget=forms.PasswordInput(attrs={'class': 'w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm'}))
class LoginForm(AuthenticationForm):
